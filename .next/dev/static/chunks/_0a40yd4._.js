...
function CompareTray() {
    _s();
    const { selectedVehicles, removeVehicle, clear } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$compare$2f$CompareTrayProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCompareTray"])();
...
_s(CompareTray, "zlhY/Q/zD9VbIF/Q7Tu10NBePbs=", false, function() {
    return [
...
function CompareTrayProvider({ children }) {
    ...
    const clear = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CompareTrayProvider.useCallback[clear]": ()=>setStoredIds([])
...
_s(CompareTrayProvider, "GtWAt53YeUwn+5CHCDQdLqTb/H4=", false, function() {
    return [
...
_s(MobileNav, "KWnTYU6SMtW3H+e++zSawuu/oVc=", false, function() {
    return [
...
//# sourceMappingURL=_0a40yd4._.js.map