...
"[project]/components/compare/AddToCompareButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(AddToCompareButton, "cgPi8N4BCJApYSd+9808kQCRfrU=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$compare$2f$VehicleSelector$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/compare/VehicleSelector.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$compare$2f$CompareTrayProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/compare/CompareTrayProvider.tsx [app-client] (ecmascript)");
...
function CompareTool({ vehicles, initialA = "", initialB = "", compact = false }) {
    ...
    const activeCategoryMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompareTool.useMemo[activeCategoryMode]": ()=>{
            if (selected.a) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.a);
            if (selected.b) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.b);
            return null;
        }
    }["CompareTool.useMemo[activeCategoryMode]"], [
        selected.a,
    ...
    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompareTool.useMemo[validation]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateComparison"])(modelA, modelB)
    }["CompareTool.useMemo[validation]"], [
        modelA,
        modelB
    ]);
    ...
    const vehiclesForA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompareTool.useMemo[vehiclesForA]": ()=>{
            ...
            if (activeCategoryMode) {
                list = list.filter({
                    "CompareTool.useMemo[vehiclesForA]": (v)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(v) === activeCategoryMode
                }["CompareTool.useMemo[vehiclesForA]"]);
            }
            return list;
        }
    ...
    const vehiclesForB = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CompareTool.useMemo[vehiclesForB]": ()=>{
            ...
            if (activeCategoryMode) {
                list = list.filter({
                    "CompareTool.useMemo[vehiclesForB]": (v)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(v) === activeCategoryMode
                }["CompareTool.useMemo[vehiclesForB]"]);
            }
            return list;
        }
    ...
    function handleSelectA(id) {
        ...
        if (id) {
            ...
            if (newA && selected.b && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(newA) !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.b)) {
                setModelB("");
            }
        }
    }
    function handleSelectB(id) {
        ...
        if (id) {
            ...
            if (newB && selected.a && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(newB) !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.a)) {
                setModelA("");
            }
        }
    }
    function handleSetMode(mode) {
        ...
        if (selected.a && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.a) !== mode) {
            setModelA("");
        }
        if (selected.b && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(selected.b) !== mode) {
            setModelB("");
        }
    }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    activeCategoryMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$compare$2f$VehicleSelector$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VehicleSelector"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: !validation.isValid && validation.errorType === "mismatch" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                selected.a ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>setModelB(""),
                                    ...
                                    children: [
                                        ...
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicleLabel"])(selected.a)
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/components/compare/CompareTool.tsx",
                                    lineNumber: 221,
                                ...
                                selected.b ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>setModelA(""),
                                    className: "rounded-xl border border-red-700 bg-red-900/80 px-4 py-2 text-xs font-bold uppercase tracking-wider text-white hover:bg-red-800",
                                    children: [
                                        "Clear Vehicle A & Keep ",
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicleLabel"])(selected.b)
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/components/compare/CompareTool.tsx",
                                    lineNumber: 230,
                    ...
                    lineNumber: 209,
                    columnNumber: 11
                }, this) : !selected.a && !selected.b ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    lineNumber: 251,
                    columnNumber: 11
                }, this) : !validation.isValid ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(CompareTool, "G1TP2CRaPTxnDPbYzMS6pJUlr0w=", false, function() {
    return [
...
function SpecComparisonTable({ vehicleA, vehicleB, category: propCategory }) {
    const activeCategory = propCategory ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVehicleCategory"])(vehicleA);
    ...
    const carRows = [
        ...
        },
        {
            ...
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.fuelType ? vehicleA.fuelType.toUpperCase() : null),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.fuelType ? vehicleB.fuelType.toUpperCase() : null)
        },
        {
            label: "Seating Capacity (सीटिंग क्षमता)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.seatingCapacity, " Seats"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.seatingCapacity, " Seats")
        },
        {
            label: "Boot Space (बूट स्पेस)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.bootSpaceLiters, " Liters"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.bootSpaceLiters, " Liters")
        },
        {
            label: "Ground Clearance (ग्राउंड क्लिअरन्स)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.groundClearanceMm, " mm"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.groundClearanceMm, " mm")
        },
        {
            label: "Airbags Safety (एअरबॅग्स)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.airbagsCount, " Airbags"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.airbagsCount, " Airbags")
        },
        {
        ...
        },
        {
            ...
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.dimensionsMm),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.dimensionsMm)
        }
    ];
    const bikeRows = [
        {
        ...
        },
        {
            ...
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.maxPowerPs),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.maxPowerPs)
        },
        {
            label: "Max Torque (टॉर्क)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.maxTorqueNm),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.maxTorqueNm)
        },
        {
            label: "Mileage / Range (मायलेज / रेंज)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMileageOrRange"])(vehicleA),
        ...
        },
        {
            ...
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.kerbWeightKg, " kg"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.kerbWeightKg, " kg")
        },
        {
            label: "Fuel Tank Capacity (फ्युएल टँक)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.fuelTankCapacityLiters, " L"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.fuelTankCapacityLiters, " L")
        },
        {
            label: "Seat Height (सीटची उंची)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.seatHeightMm, " mm"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.seatHeightMm, " mm")
        },
        {
            label: "Brakes System (ब्रेकिंग सिस्टम)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.brakes),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.brakes)
        },
        {
            label: "Top Speed (टॉप स्पीड)",
            valueA: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleA.topSpeedKmph, " km/h"),
            valueB: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatSpecValue"])(vehicleB.topSpeedKmph, " km/h")
        }
    ];
...
"[project]/components/compare/VehicleSelector.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VehicleSelector({ id, label, vehicles, value, excludeId, category, onChange }) {
    ...
    const cars = filtered.filter((v)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBike"])(v));
    const bikes = filtered.filter((v)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBike"])(v));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                ...
                children: [
                    ...
                    (!category || category === "car") && cars.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("optgroup", {
                        label: "🚗 Cars / 4-Wheelers",
                        className: "bg-zinc-900 text-red-500 font-bold",
                        children: cars.map((vehicle)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                value: vehicle.id,
                                className: "bg-zinc-900 text-white font-normal",
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicleLabel"])(vehicle),
                                    " ",
                    ...
                    (!category || category === "bike") && bikes.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("optgroup", {
                        label: "🏍️ Bikes & Scooters",
                        className: "bg-zinc-900 text-amber-500 font-bold",
                        children: bikes.map((vehicle)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                value: vehicle.id,
                                className: "bg-zinc-900 text-white font-normal",
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicleLabel"])(vehicle),
...
_c = VehicleSelector;
var _c;
__turbopack_context__.k.register(_c, "VehicleSelector");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_compare_1xtl92x._.js.map